...
namespace AppGame.Data.Local
{
    public class DeviceInfoManager : IDeviceInfoManager
    {
        ...
        public void Initialize()
        {
            ...
            deviceInfos.Add(new DeviceInfo() { ID = "01", Type = DeviceTypes.Walk, Name = "背背佳", Count = 1 });
            deviceInfos.Add(new DeviceInfo() { ID = "02", Type = DeviceTypes.Ride, Name = "平衡车", Count = 1 });
